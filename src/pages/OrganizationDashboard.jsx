...
<body>
  <div class="certificate">
    ...
    <div class="bottom-section">
      ...
      <div class="qr-and-id">
        <div class="qr-code">
          <img src="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=https://certiverse.app/verify/${officialId}" width="86" height="86" alt="QR Code de vérification">
        </div>
